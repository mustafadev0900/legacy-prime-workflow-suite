      ...
      messages: [
        {
          ...
          content: [
            ...
            '',
            'Rules:',
            '- ONLY output lines for questions that appear in the input. Do NOT add extra lines or invent fields.',
            ...
            '  Examples: "When are you looking to start?" → "Start", "Are you getting other quotes?" → "Other Quotes", "How did you hear about us?" → "Referral".',
            '  If answer is empty or "(no answer)", write "Not specified".',
            '- Include EVERY question in the input — do not skip any. Do not add any that are not in the input.',
            '',
            'Example — if input has Project + 2 questions, output has exactly 3 lines:',
            'Kitchen Remodel - Budget: $10,000',
            'Start: Next month',
            'Other Quotes: Yes, two others',
            '',
